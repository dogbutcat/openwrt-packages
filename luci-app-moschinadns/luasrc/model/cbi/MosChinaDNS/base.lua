...
local configpath=uci:get("MosChinaDNS","MosChinaDNS","configpath") or "/etc/config/MosChinaDNS.yaml"
local binpath=uci:get("MosChinaDNS","MosChinaDNS","binpath") or "/usr/bin/MosChinaDNS/MosChinaDNS"
httpport=uci:get("MosChinaDNS","MosChinaDNS","httpport") or "3000"
m = Map("MosChinaDNS", "Mos ChinaDNS")
m.description = translate("Free and open source, powerful network-wide ads & trackers blocking DNS server.")
m:section(SimpleSection).template  = "MosChinaDNS/MosChinaDNS_status"

s = m:section(TypedSection, "MosChinaDNS")
s.anonymous=true
s.addremove=false
---- enable
...
-- o.datatype="port"
-- o.optional = false
-- o.description = translate("<input type=\"button\" style=\"width:210px;border-color:Teal; text-align:center;font-weight:bold;color:Green;\" value=\"MosChinaDNS Web:"..httpport.."\" onclick=\"window.open('http://'+window.location.hostname+':"..httpport.."/')\"/>")
---- update warning not safe
local binmtime=uci:get("MosChinaDNS","MosChinaDNS","binmtime") or "0"
local e=""
...
o.template = "MosChinaDNS/MosChinaDNS_check"
...
o:value("redirect", translate("Redirect 53 port to MosChinaDNS"))
o:value("exchange", translate("Use port 53 replace dnsmasq"))
o.default     = "none"
o.optional = true
---- bin path
o = s:option(Value, "binpath", translate("Bin Path"), translate("MosChinaDNS Bin path if no bin will auto download"))
o.default     = "/usr/bin/MosChinaDNS/MosChinaDNS"
o.datatype    = "string"
o.optional = false
o.rmempty=false
...
o.rmempty = true
---- config path
o = s:option(Value, "configpath", translate("Config Path"), translate("MosChinaDNS config path"))
o.default     = "/etc/config/MosChinaDNS.yaml"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- work dir
o = s:option(Value, "workdir", translate("Work dir"), translate("MosChinaDNS work dir include rules,audit log and database"))
o.default     = "/usr/bin/MosChinaDNS"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- log file
o = s:option(Value, "logfile", translate("Runtime log file"), translate("MosChinaDNS runtime Log file if 'syslog': write to system log;if empty no log"))
o.datatype    = "string"
o.rmempty = true
o.validate=function(self, value)
if fs.stat(value,"type")=="dir" then
...
o.write=function()
	luci.sys.exec("sh /usr/share/MosChinaDNS/gfw2adg.sh del 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","MosChinaDNS"))
end
o=s:option(Button,"gfwadd",translate("Add gfwlist"),translate(a))
o.optional = true
o.inputtitle=translate("Add")
o.write=function()
	luci.sys.exec("sh /usr/share/MosChinaDNS/gfw2adg.sh 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","MosChinaDNS"))
end
...
o.default     = ""
o.datatype    = "string"
o.template = "MosChinaDNS/MosChinaDNS_chpass"
o.optional = true
---- upgrade protect
...
local workdir=uci:get("MosChinaDNS","MosChinaDNS","workdir") or "/usr/bin/MosChinaDNS"
...
o1.default     = "/usr/bin/MosChinaDNS"
o1.datatype    = "string"
o1.optional = false
...
o.cfgvalue = function(self, section)
	return fs.readfile("/usr/share/MosChinaDNS/links.txt")
end
o.write = function(self, section, value)
	fs.writefile("/usr/share/MosChinaDNS/links.txt", value:gsub("\r\n", "\n"))
end
...
function m.on_commit(map)
	...
	local ucitracktest=uci:get("MosChinaDNS","MosChinaDNS","ucitracktest")
	...
	elseif ucitracktest=="0" then
		...
		if (fs.access("/var/run/AdGlucitest")) then
			uci:set("MosChinaDNS","MosChinaDNS","ucitracktest","0")
			io.popen("/etc/init.d/MosChinaDNS reload &")
		else
			fs.writefile("/var/run/AdGlucitest","")
			if (ucitracktest=="2") then
				uci:set("MosChinaDNS","MosChinaDNS","ucitracktest","1")
			else
				uci:set("MosChinaDNS","MosChinaDNS","ucitracktest","2")
			end
		end
		uci:save("MosChinaDNS")
	end
